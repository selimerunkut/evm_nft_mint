...
import hashArray  from './metadataHashIpfs.js'; // Relative path to your File
...
const getRandomTokenURI = () => {
  let ipfsHashes = hashArray
  const randomHash = ipfsHashes[Math.floor(Math.random() * ipfsHashes.length)];
...
console.log("localProviderUrlFromEnv",localProviderUrlFromEnv)
            ...
            <div style={{ width: 640, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
              ...
              <div style={{padding:32}}>
                <Button
                  onClick={async () => {
                    console.log("MINT!");
                    console.log("get random token uri!");
                    const tokenURI = getRandomTokenURI()
                    tx(writeContracts.YourCollectible.publicSaleMint(1, tokenURI, {value: ethers.utils.parseEther("0.001")}));
                  }}
                >
                  Mint
                </Button>
